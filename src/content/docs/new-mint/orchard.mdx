...
<Aside type="tip" title="Orchard is up">
  The dashboard at `https://minibolt.local:4321` means Orchard built, started, and is
  ready to connect to the services you configured. Finish wiring it from the dashboard.
</Aside>
...
Orchard, the same way MiniBolt does for ThunderHub.
