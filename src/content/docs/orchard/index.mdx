---
title: Your Orchard
description: Operate your Cashu mint with Orchard — set up your instance, then tend the dashboard, crew, settings, and the Bitcoin, Lightning, and Mint services it manages, all from one place.
---

import { Aside, CardGrid, LinkCard } from '@astrojs/starlight/components';

Once Orchard is installed and running, these guides give you an overview of the application.
Orchard is an all-in-one manager that gives you a full view of your services — Bitcoin,
Lightning, and a Cashu mint — and the tools to operate them from a single dashboard.
...
<figcaption>Orchard gives you the full picture of every service from one dashboard.</figcaption>
