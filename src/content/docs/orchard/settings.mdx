...
Everything is organised under three top-level tabs:
...
{/* separate from the environmentvariables you set when you [installed it](/install/configuration/) */}
...
price from your own node's on-chain data once a day, at 00:00 UTC. There is no exchange API involved, no
third-party feeds at all to preserve your privacy. It uses the open-source
...
The agent is completly customizable. You can define:
